...
exports.clearTempFiles = exports.displayIps = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(Object.keys(req.files).map(function (file) {
                            return req.files[file].tempFilePath !== undefined &&
                                req.files[file].tempFilePath !== ''
                                ? fs_extra_1["default"].remove(req.files[file].tempFilePath)
                                : Promise.resolve();
                        }))];
                case 1:
                    _a.sent();
