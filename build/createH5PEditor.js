...
var h5p_mongos3_1 = __importDefault(require("@lumieducation/h5p-mongos3"));
/**
...
function createH5PEditor(config, localLibraryPath, localContentPath, localTemporaryPath, translationCallback) {
    return __awaiter(this, void 0, void 0, function () {
        var cache, h5pEditor, _a, _b, _c, _d, _e, _f, _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    if (process.env.CACHE === 'in-memory') {
                        cache = cache_manager_1.caching({
                            store: 'memory',
                            ttl: 60 * 60 * 24,
                            max: Math.pow(2, 10)
                        });
                    ...
                    _c = [void 0, new H5P.cacheImplementations.CachedKeyValueStorage('kvcache', cache),
                        config,
                        process.env.CACHE
                    ...
                    return [3 /*break*/, 3];
                case 1:
                    _f = (_e = h5p_mongos3_1["default"].MongoS3ContentStorage).bind;
                    _g = [void 0, h5p_mongos3_1["default"].initS3({
                            s3ForcePathStyle: true,
                            signatureVersion: 'v4'
                        })];
                    return [4 /*yield*/, h5p_mongos3_1["default"].initMongo()];
                case 2:
                ...
                case 3:
                    h5pEditor = new (_b.apply(_a, _c.concat([_d, process.env.TEMPORARYSTORAGE === 's3'
                            ? new h5p_mongos3_1["default"].S3TemporaryFileStorage(h5p_mongos3_1["default"].initS3({
                                s3ForcePathStyle: true,
                                signatureVersion: 'v4'
                            }), {
                    ...
                    if (!(h5pEditor.temporaryStorage instanceof
                        h5p_mongos3_1["default"].S3TemporaryFileStorage)) return [3 /*break*/, 5];
